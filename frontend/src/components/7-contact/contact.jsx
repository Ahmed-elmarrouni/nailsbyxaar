        ...
        <div className={styles.layoutContainer}>
            ...
            <aside className={styles.sidebar}>
                ...
                <div className={styles.socialIcons}>
                    ...
                    <a href="#" aria-label="Instagram"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                    ...
                    <a href="#" aria-label="TikTok"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
                    ...
                    <a href="#" aria-label="WhatsApp"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 50 50">
            ...
            {/* Main Form Section (Switching Only This) */}
            <div className={styles.formSection}>
                ...
                {/* AnimatePresence only affects the form section (Sidebar stays stable) */}
                        ...
                        >
                            <div className={styles.bookingGrid}>
                                ...
                                <div className={styles.formGroup}>
                                    ...
                                    <select id="bookingOffer" name="bookingOffer" required>
                                ...
                                <div className={`${styles.formGroup} ${styles.fullWidth}`}>
                                    ...
                                    <textarea id="bookingMessage" name="bookingMessage" rows="5"></textarea>
                                </div>
                            </div>
