...
//                         onClick={() => handleCardClick("Gel with Color")}
//                     >
...
//                     <button
//                         className={styles.button}
//                         onClick={() => handleCardClick("French Tips")}
//                     >
//                         {translations.services.bookNow}
//                     </button>
...
//                     <button
//                         className={styles.button}
//                         onClick={() => handleCardClick("Designs & Extras")}
//                     >
//                         {translations.services.bookNow}
//                     </button>
...
const Services = ({ onSelectOffer }) => {
    ...
    const handleBookNow = (offer) => {
        if (onSelectOffer) {
            onSelectOffer(offer); // Call function in Contact component
        }
    };
        ...
        <div className={styles.pricingContainer} id="services">
            ...
            <div className={styles.pricingCards}>
                ...
                <div className={styles.card}>
                    ...
                    <button className={styles.button} onClick={() => handleBookNow("Gel with Color")}>
                        {translations.services.bookNow}
                    </button>
                </div>
                ...
                <div className={`${styles.card} ${styles.businessCard}`}>
                    ...
                    <button className={styles.button} onClick={() => handleBookNow("French Tips")}>
                        {translations.services.bookNow}
                    </button>
                </div>
                ...
                <div className={styles.card}>
                    ...
                    <button className={styles.button} onClick={() => handleBookNow("Designs & Extras")}>
                        {translations.services.bookNow}
                    </button>
                </div>
            </div>
